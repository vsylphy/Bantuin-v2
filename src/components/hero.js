...
// Dikelompokkan 2-2 supaya visual hero menampilkan dua foto sekaligus,
// lalu bergantian ke pasangan berikutnya secara berkala.
    ...
    <section class="hero-section relative overflow-hidden">
      ...
      <div class="container-nav relative z-10 hero-container">
        ...
        <div class="hero-columns">
          ...
          <!-- Kanan: visual utama (2 foto) + kartu melayang -->
